#lang racket
(provide exercise float-right panopto-vid shell shell-result feedback-form)
...
(define (feedback-form)
 (elem #:style
  (style #f
         (list (alt-tag "iframe")
               (attributes
                 '((src . "https://docs.google.com/forms/d/e/1FAIpQLSfEJA6oe4PnkS2wmxYjCrv4fYK9mltaordd3uQEonieAJiAjA/viewform?embedded=true")
		   (width . "640")
		   (height . "407")
		   (frameborder . "0")
		   (marginheight . "0")
